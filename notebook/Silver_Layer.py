...
spark.conf.set("fs.azure.account.oauth2.client.id.storageforaw.dfs.core.windows.net", "096b1dc5-2e09-****-82e1-e9f7a07b6633")
...
spark.conf.set("fs.azure.account.oauth2.client.endpoint.storageforaw.dfs.core.windows.net", "https://login.microsoftonline.com/78a8d6c4-****-4ea1-8080-dba2e0695e47/oauth2/token")
